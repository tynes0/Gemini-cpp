...
namespace GeminiCPP
{
    ...
    public:
        ...
        virtual std::optional<ChatSession> load(const std::string& sessionId, Client* client) = 0;
    ...
    public:
        ...
        std::optional<ChatSession> load(const std::string& sessionId, Client* client) override;
